    ...
    <section className="w-full bg-[url('/image/loging_bg.png')] bg-cover bg-center my-4">
        <div className="max-w-[1280px] mx-auto px-4">
            <div className="flex lg:flex-row items-center gap-2">
                ...
                {/* login fields */}
                <div className="lg:px-[80px] lg:py-[80px]">
                    ...
                    <form action="">
                        ...
                        <div className="my-2">
                            ...
                            <div className="w-[350px] h-[40px] flex items-center gap-4 px-4 border-[2px] border-solid border-[#6c14d0] rounded-[5px]">
                        ...
                        {/* login button */}
                        <button className="w-[350px] text-white px-[20px] py-[7px] border-none rounded-[5px] cursor-pointer text-[20px] bg-gradient-to-r from-[#c72092] to-[#6c14d0] mt-2" type="submit">
                            Login
                        </button>
                        ...
                        <div className="flex items-center justify-center gap-2 mt-6">
                            <div className="w-[30px] h-[30px] mx-[2px] rounded-full bg-[#f3f3f3] shadow-loginShad">
                                 <img src="/image/google.png" alt="" className="w-[20px] m-[5px]"/>
                            </div>
                            <div className="w-[30px] h-[30px] mx-[2px] rounded-full bg-[#f3f3f3] shadow-loginShad">
                                 <img src="/image/facebook.png" alt="" className="w-[20px] m-[5px]"/>
                            </div>
                            <div className="w-[30px] h-[30px] mx-[2px] rounded-full bg-[#f3f3f3] shadow-loginShad">
                                 <img src="/image/twitter.png" alt="" className="w-[20px] m-[5px]"/>
                            </div>
                        </div>
                    </form>
                </div>
